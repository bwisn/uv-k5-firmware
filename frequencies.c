...
FREQUENCY_Band_t FREQUENCY_GetBand(uint32_t Frequency) {
    const uint32_t limits[] = {7600001, 13799991, 17399991, 34999991, 45099991, 52999991, 60000001};
    const FREQUENCY_Band_t bands[] = {
        BAND1_50MHz, BAND2_108MHz, BAND3_136MHz, BAND4_174MHz,
        BAND5_350MHz, BAND6_400MHz, BAND7_470MHz, BAND6_400MHz};

    for (uint8_t i = 0; i < 7; i++) {
        if (Frequency < limits[i]) {
            return bands[i];
        }
    }
